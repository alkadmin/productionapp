...
import IssueProduction from '../../components/IssueProductionVariety/IssueProductionVariety';
import ReceiptProduction from '../../components/ReceiptProductionVariety/ReceiptProductionVariety';
...
const ProductionOrder = () => {
  ...
  const fetchOrder = async () => {
    const response = await fetch(`/api/OneProductionOrderVariety/${id}`);
    const data = await response.json();
    setOrder(data);
    console.log(data)
