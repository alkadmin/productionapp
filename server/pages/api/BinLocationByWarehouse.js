...
async function handler(req, res) {
    ...
    try {
        conn = await (0,_dataBase_dbConnection__WEBPACK_IMPORTED_MODULE_0__/* .getConnection */ .B)(warehouse);
...
var __webpack_exports__ = __webpack_require__.X(0, [8970], () => (__webpack_exec__(2414)));
