...
// pages/api/getProductionOrdersTorts.js

async function handler(req, res) {
    let conn;
    try {
        conn = await (0,_dataBase_dbConnection__WEBPACK_IMPORTED_MODULE_0__/* .getConnection */ .B)();
        const query = "CALL CTS_ARTESANO_PROD_GET_PRODUCTION_ORDERS_TORTS_HEADER";
...
var __webpack_exports__ = __webpack_require__.X(0, [8970], () => (__webpack_exec__(8795)));
